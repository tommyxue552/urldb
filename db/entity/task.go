...
const (
	TaskTypeAuthorizedTransfer TaskType = "authorized_transfer"
)
...
// Task 任务表
type Task struct {
	// Nil for legacy tasks. Authorized-transfer requests set a stable unique key.
	IdempotencyKey *string `json:"-" gorm:"size:150;uniqueIndex"`
